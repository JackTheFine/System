  ...
  async execute(interaction, client) {
    if (interaction.member.roles.cache.has("1023321861049823344") || interaction.user.id == "710257546908139649") {
        ...
        for await (const card of data) {
            ...
            (await client.users.fetch(card.name))?.send("Hello! This is a test of the quota reminder, if you get this message please ping @jackthefine (<@710257546908139649>) in <#1023326139218927616> and tell him you got the dm. Thanks!");
        }
