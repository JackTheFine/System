...
module.exports = {
  ...
  async execute(interaction, client) {
    ...
    interaction.guild.channels.cache.get('1216412757117763664').send({ content: `<@&1105653389410443294>`,embeds: [embed] }).then(embed => {embed.react("1️⃣").then(embed.react("2️⃣")).then(embed.react("3️⃣")).then(embed.react("4️⃣")).then(embed.react("5️⃣")).then(embed.react("6️⃣")).then(embed.react("7️⃣")).then(embed.startThread({name: 'Vote discussion', reason: 'Use this thread to discuss the proof.' }))})
